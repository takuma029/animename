...
<ul id="loc"></ul>
<form action="./phpb10.php" method="POST">
...
$query="select name,pre,muni,location<->ST_GeomFromText('POINT(139.7863502 35.63119745)',4326)" .
"as distance from anime2 order by distance asc;";
